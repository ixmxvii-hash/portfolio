...
const socials = [
  {
    label: "GitHub",
    href: "https://github.com/ixmxvii-hash",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/yourl0nlystar",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/in/logan-allen",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        >
          ...
          <p className="mx-auto mb-10 max-w-lg text-lg text-text-secondary">
            Have a project in mind, need IT solutions, or just want to connect?
        ...
        >
          {socials.map((social) => (
            <a
              ...
              className="flex h-11 w-11 items-center justify-center rounded-xl border border-border-subtle text-text-muted transition-all hover:border-border hover:bg-surface hover:text-text-primary"
